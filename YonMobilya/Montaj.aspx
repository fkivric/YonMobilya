                        ...
                        <div class="card-body">
                                            ...
                                            <asp:TemplateField HeaderText="Seçim" ItemStyle-Width="100px">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="chkSelect" runat="server" CssClass="ddl">
                                                        <asp:ListItem Value="0" Text="Sonuç" Selected="True"></asp:ListItem>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="row gx-3 gy-2 align-items-center">
                                    <div runat="server" id="uploadarea" class="row" visible="false">
                                        <div runat="server" id="resim1" class="col-md-3">
                                            <div class="card">
                                                <div>
                                                    <div runat="server" id="Div1" class="number"></div>
                                                    <div class="cardName">Montaj Resmi Önden</div>
                                                </div>
                                        ...
                                        <div runat="server" id="resim3" class="col-md-3">
                                            <div class="card">
                                                <div>
                                                    <div runat="server" id="Div3" class="number"></div>
                                                    <div class="cardName">Sorunlu Parça Resmi</div>
                                                </div>
                                                ...
                                                <asp:Button ID="btnUpload3" type="submit" Text="Upload" runat="server" OnClick="btnUpload3_Click"></asp:Button>
                                        ...
                                        <div runat="server" id="resim4" class="col-md-3">
                                            <div class="card">
                                                <div>
                                                    ...
                                                    <div class="cardName">Ek Resim 2</div>
                                                </div>
